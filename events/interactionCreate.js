    ...
    async function createTicket(ticketType, reason) {
      ...
      client.guilds.cache.get(client.config.guildId).channels.create({
        ...
        .setDescription(
          ...
          .replace('REASON', reason))
        .setFooter({
          text: "Made By 👑ᴀɴᴏɴ👑 Powered By : Riun (Pvt) Ltd." + client.embeds.ticketOpened.footer.text.replace("Made By 👑ᴀɴᴏɴ👑 Powered By : Riun (Pvt) Ltd.", ""), // Please respect the LICENSE :D
